export const mainEvents = [
  ...
  },
  {
    ...
    organizer: 'Design Tab',
    location: 'Online',
    date: '',
    time: '',
    image: 'neo_palette_image_url',
  },
  {
    title: 'Punchline Panchayat',
    description:
    ...
    organizer: 'OPEN MIC CLUB',
    location: 'BBA',
    date: 'Day 2',
    time: 'To be confirmed',
    image: 'punchline_panchayat_image_url',
  },
  {
    title: 'Mini Chassis Making Competition',
    description:
    ...
    date: '',
    time: '',
    image: 'mini_chassis_making_image_url',
  },
  {
    title: 'MateriaXplore',
    description:
    ...
    date: '',
    time: '',
    image: 'materia_xplore_image_url',
  },
  {
    title: 'IPL Auction',
    description:
    ...
    time: 'To be confirmed',
    duration: '6 Hours',
    image: 'ipl_auction_image_url',
  },
  {
    title: 'Beyond the Basics',
    description:
      'Are you ready to demonstrate your expertise in the dynamic world of stock markets and trading? Bears and Bulls club is organizing a quiz for testing your trading knowledge. Delve into thought-provoking questions covering market trends, portfolio management, technical analysis, and much more. Compete, learn, and showcase your proficiency in the ever-evolving landscape of the stock market.',
    organizer: 'Bears and Bulls',
    location: 'LA',
    date: '',
    time: '',
    image: 'beyond_the_basics_image_url',
  },
  {
    title: 'Brainy Escape',
    description:
    ...
    organizer: 'The Bioscience Society',
    location: 'LA, Rooms 114 & 104',
    date: 'Day 1',
    duration: '3 hours',
    time: 'To be confirmed',
    image: 'brainy_escape_image_url',
  },
  {
    title: 'OpenChase: a Hybrid Treasure Hunt',
    description:
    ...
    date: '',
    time: '',
    image: 'openchase_image_url',
  },
  {
    title: 'Virtual Racing Simulator Competition',
    description:
    ...
    date: '',
    time: '',
    image: 'virtual_racing_simulator_image_url',
  },
  {
  ...
  },
  {
    ...
    date: '',
    time: '',
    image: 'webclone_mania_image_url',
  },
  {
    title: 'Brainboxed 2.0',
    description:
    ...
    organizer: 'Analytics and Consulting',
    location: 'Room with at least 200+ seating capacity',
    date: 'Day 2 and Day 3',
    duration: '2 hours each day',
    expected_participants: '300 (approximately 100 teams for the preliminary round)',
    time: 'To be confirmed',
    image: 'brainboxed_2.0_image_url',
  },
  {
    title: 'ElectroQuest',
    description:
    ...
    organizer: 'Short Circuit',
    location: 'LA-1',
    date: '',
    time: '',
    image: 'electroquest_image_url',
  },
  {
    title: 'TURBOGEN-X',
    description:
    ...
    organizer: 'ASME NIT Rourkela Student Section',
    location: 'LA Room',
    date: '',
    time: '',
    image: 'turbogen_x_image_url',
  },
  {
    title: 'NITR HoloCampus: A Futuristic Live Experience',
    description:
    ...
    organizer: 'Game To Aim (GTA)',
    location: 'Open Place in BBA',
    date: 'Day 1, Day 2, Day 3',
    duration: '',
    time: '',
    image: 'nitr_holocampus_image_url',
  },
  {
    title: 'Simulating Solutions 2.0',
    description:
      'Simulating Solutions 2.0 is an exhilarating competition hosted by the AIChe NIT Rourkela Student Chapter, the vibrant community for chemical engineers and enthusiasts. Participants will face a series of engaging crosswords, quizzes, and challenging riddles that will lead your team to the grand finale. Chemical engineer or not, this competition is for everyone. So, brush up your chemistry skills and prepare to think outside the box—join us for a thrilling experience!',
    organizer: 'AIChE NIT Rourkela Student Chapter',
    location: '',
    date: '',
    time: '',
    image: 'simulating_solutions_2.0_image_url',
  },
  {
    title: 'Shark Hunt',
    description:
    ...
    organizer: 'Team TIBURON',
    location: 'LA Room',
    date: 'Day 2',
    time: 'To be confirmed',
    image: 'shark_hunt_image_url',
  },
  {
    title: 'JNANAGNI',
    description:
    ...
    organizer: 'INQUIZZITIVE',
    location: 'PPA (most preferable) or The Big Rooms in LA-I',
    date: 'Day 2',
    time: '3 PM - 6 PM',
    image: 'jnanagni_image_url',
  },
  {
    title: 'Era of Estates',
    description:
    ...
    date: '',
    time: '',
    image: 'era_of_estates_image_url',
  },
  {
    title: 'Inter NITR Clubs Hackathon',
    description:
      'Represent your club and participate in the Inter NITR Clubs Hackathon, organized by the club 3D of NITR where data, design, and development unite. The Hackathon encourages participants to think creatively and develop unique solutions to real-world problems while also fostering teamwork and promoting a spirit of competition. Two rounds will be conducted, one online and the other offline, and the team performing the best will be crowned the winner.',
    organizer: '3D',
    location: '',
    date: '',
    time: '',
    image: 'inter_nitr_clubs_hackathon_image_url',
  },
  {
    title: 'INTELLIGENT TRADER',
    description:
    ...
    date: '',
    time: '',
    image: 'intelligent_trader_image_url',
  },
  {
    title: 'Robo-Sumo War',
    description:
      '"Only the strongest can dominate the ring." Prepare for the Robo-Sumo War, where robots face off in a thrilling wrestling match on an enclosed circular platform. With increased fight space and strategic moves, competitors will push their robots to the limit in this high-energy event!',
    organizer: 'CYBORG',
    location: 'Hall in LA-1 (in front of elevator)',
    date: 'Day 2',
    time: 'To be confirmed',
    image: 'robo_sumo_war_image_url',
  },
  {
    title: 'Shake It Off',
    description:
  ...
  },
  {
    ...
    Location: 'LA-1 or LA-2 (the circle base)',
    Date: 'Day 3',
    Duration: '6 Hours',
    Time: 'To be confirmed',
  },
